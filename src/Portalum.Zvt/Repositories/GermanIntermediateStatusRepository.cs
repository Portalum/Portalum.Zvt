    ...
    public class GermanIntermediateStatusRepository : IIntermediateStatusRepository
    {
        ...
        public GermanIntermediateStatusRepository(Dictionary<byte, string>? additionalStatusCodes = null)
        {
            this._statusCodes = new Dictionary<byte, string>
            {
                ...
                { 0x5E, "BZT hat das Lesen der kontaktlosen Karte beendet.\n(2. Kontaktlose LED)" },
                ...
                { 0x6A, "PIN Ziffer eingegeben" },
                { 0x6B, "PIN Ziffer eingegeben, Bestätigung möglich" },
                { 0x6C, "Korrekturtaste bestätigt, letzte Ziffer gelöscht" },
                { 0x6D, "Pin Eingabe erfolgt" },
                //A0->A5 - Use the `IngenicoGermanIntermediateStatusRepository`
