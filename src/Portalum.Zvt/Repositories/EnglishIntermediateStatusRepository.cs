    ...
    public class EnglishIntermediateStatusRepository : IIntermediateStatusRepository
    {
        ...
        public EnglishIntermediateStatusRepository(Dictionary<byte, string>? additionalStatusCodes = null)
        {
            this._statusCodes = new Dictionary<byte, string>
            {
                ...
                { 0x5D, "Declined\nPlease remove card!" },
                { 0x5E, "Signal of Contactless Card access finished\n(2.contactless LED)" },
                ...
                { 0x6A, "PIN digit entered" },
                { 0x6B, "PIN digit entered, confirmation possible" },
                { 0x6C, "Correction key entered, last digit deleted" },
                { 0x6D, "PIN entered" },
                //A0->A5 - Use the `IngenicoEnglishIntermediateStatusRepository`
